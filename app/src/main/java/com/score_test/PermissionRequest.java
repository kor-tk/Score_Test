...
public class PermissionRequest {
    ...
    private PermissionRequest(Activity context) { this.context = context; }
    ...
    public static class Builder {
        ...
        public Builder(Activity context) { requester = new PermissionRequest(context); }
        ...
        public PermissionRequest create() { this.requester.setBuilder(this); return this.requester; }
    }
